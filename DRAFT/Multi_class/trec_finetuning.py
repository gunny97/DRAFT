...
def main(TRAIN_MODE, random_state, ss_size):
    ...
    label_0_data = pd.read_csv(f"../../building_dataset/trec/0th_label_{random_state}.csv")
    label_1_data = pd.read_csv(f"../../building_dataset/trec/1th_label_{random_state}.csv")
    label_2_data = pd.read_csv(f"../../building_dataset/trec/2th_label_{random_state}.csv")
    label_3_data = pd.read_csv(f"../../building_dataset/trec/3th_label_{random_state}.csv")
    label_4_data = pd.read_csv(f"../../building_dataset/trec/4th_label_{random_state}.csv")
    label_5_data = pd.read_csv(f"../../building_dataset/trec/5th_label_{random_state}.csv")
    ...
    query_result = construct_queries(trec_train_df, 8, random_state)       
